...
Route::get('/getdistrict/{id}', 'PagesController@getDistrict'); ///use
Route::get('/subdistrict/{id}', 'PagesController@getTumbol');    ///use
// Route::get('/getVillage/{id}', 'PagesController@getVillage');

Route::get('/getVillage/{amp}/{tambol}', 'PagesController@getVillage');
